...
import { verify,checkMail } from "../Middleware/userVerification.js";
import { verifyOtp } from "../Middleware/verifyOtp.js";
import { changePassword } from "../Middleware/changePassword.js";

import {getMyAcademicInfo,getMyLecture } from "../controller/userStudent.js";
...
import {  getOneAdmin,  
  ...
  updateStudent,
  getOneStudent,
  facultyFormSet,isFormAllow,getCountOfALL,setNewPass
} from "../controller/userAdmin.js";
...
router.get("/checkMail/:data", checkMail);
router.get("/isFormAllow/:data", isFormAllow);
router.post("/setNewPass", setNewPass);
router.get("/getCountOfALL", getCountOfALL);
...
router.post("/facultyFormSet", verify, facultyFormSet);
